...
class VeterinariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veterinario" do
    assert_difference('Veterinario.count') do
      post veterinarios_url, params: { veterinario: { clinica_id: @veterinario.clinica_id, cpf: @veterinario.cpf, nome: @veterinario.nome } }
    end
  ...
  test "should update veterinario" do
    patch veterinario_url(@veterinario), params: { veterinario: { clinica_id: @veterinario.clinica_id, cpf: @veterinario.cpf, nome: @veterinario.nome } }
