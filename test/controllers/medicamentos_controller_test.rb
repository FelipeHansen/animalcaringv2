...
class MedicamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicamento" do
    assert_difference('Medicamento.count') do
      post medicamentos_url, params: { medicamento: { descricao: @medicamento.descricao, nome: @medicamento.nome } }
    end
  ...
  test "should update medicamento" do
    patch medicamento_url(@medicamento), params: { medicamento: { descricao: @medicamento.descricao, nome: @medicamento.nome } }
