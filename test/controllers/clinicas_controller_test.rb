...
class ClinicasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinica" do
    assert_difference('Clinica.count') do
      post clinicas_url, params: { clinica: { descricao: @clinica.descricao, endereco: @clinica.endereco, nome: @clinica.nome } }
    end
  ...
  test "should update clinica" do
    patch clinica_url(@clinica), params: { clinica: { descricao: @clinica.descricao, endereco: @clinica.endereco, nome: @clinica.nome } }
