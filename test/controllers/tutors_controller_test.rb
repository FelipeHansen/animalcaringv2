...
class TutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post tutors_url, params: { tutor: { cpf: @tutor.cpf, nome: @tutor.nome, telefone: @tutor.telefone } }
    end
  ...
  test "should update tutor" do
    patch tutor_url(@tutor), params: { tutor: { cpf: @tutor.cpf, nome: @tutor.nome, telefone: @tutor.telefone } }
